...
if (dalsi_mise == "ano"):
    ...
    mise = (input("Zadej označení mise:"))
...
ls47 = (input("Spustit kodér LS47? ano/ne:"))
if (ls47 == "ano"):
  import random
